    ...
    return(
        <div>
            ...
            <div className="d-flex flex-column justify-content-center align-items-center my-5 px-1">
                ...
                <p className="service-offer-text text-center mx-2">Voici quelques-unes de mes realisations</p>
                <hr className="horizontal-bar border-button border-5 " style={{width: '20%'}} />
            </div>
            <div className="container-fluid">
                <div className="row d-lg-flex flex-lg-row justify-content-lg-center">
                    <div className="col-12 col-sm-6 col-lg-3 mb-4">
                        <div className="card">
                            ...
                            <div className="card-body border-bottom border-2 d-flex flex-column align-items-center px-5 text-center fw-normal">
                                ...
                                <p className="card-text">Realisation d'un site de commande en ligne.</p>
                            ...
                            <div className="card-body bg-all">
                                <p className="card-text text-center fw-normal">Site realise avec PHP et MySQL</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-12 col-sm-6 col-lg-3 mb-4">
                        <div className="card">
                            ...
                            <div className="card-body border-bottom border-2 d-flex flex-column align-items-center px-5 text-center fw-normal">
                                ...
                                <p className="card-text">Realisation d'un site vitrine.</p>
                                <button className="button rounded bg-white text-button fw-semibold border-button border-1 py-1 px-2">Voir</button>
                            </div>
                            <div className="card-body bg-all">
                                <p className="card-text text-center fw-normal">Site realise avec WordPress</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-12 col-sm-6 col-lg-3">
                        <div className="card">
                            ...
                            <div className="card-body border-bottom border-2 d-flex flex-column align-items-center px-5 text-center fw-normal">
                                <h5 className="card-title fw-semibold">Espace bien-etre</h5>
                                <p className="card-text">Realisation d'un site vitrine pour un practicien de bien-etre.</p>
                                <button className="button rounded bg-white text-button fw-semibold border-button border-1 py-1 px-2">Voir</button>
                            </div>
                            <div className="card-body bg-all">
                                <p className="card-text text-center fw-normal">Site realise en HTML/CSS</p>
                            </div>
                        </div>
                    </div>
                </div>
