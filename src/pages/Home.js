    ...
    return (
        <div>
            <div className="bg-home d-flex flex-column justify-content-center align-items-center align-middle">
                ...
                <h2 className="home-work text-white fw-semibold">Développeur web full stack</h2>
                    ...
                    <div className="row px-5 my-5">
                        <div className="col-12 col-sm-6">
                            ...
                            <p className="fw-normal">
                                Passionné par l'informatique et les nouvelles technologies, j'ai suivi une formation d'<strong>intégrateur-développeur web </strong> 
                                au CEF. Au cours de cette formation, j'ai pu acquerir des bases solides pour travailler dans le domaine du <strong>développement web</strong>.
                            </p>
                            <p className="fw-normal">
                        ...
                        <div className="col-12 col-sm-6">
                            ...
                            <div className="container mt-2 d-flex flex-column gap-3">
                                <h2 className="fw-semibold">Mes compétences</h2>
                                <div className="">
                                ...
                                <div>
                                    <p className="fw-normal">REACT 50%</p>
